...
class FileController extends BasicController
{
    ...
    static function offer_file(UploadedFile $request)
    {
        $result = [];
        ...
        if ($request != NULL) {
            ...
            //filename to store
            $filenametostore = $filename . '_' . time() . '_gesta.' . $extension;

            //Upload File
            $request->move(public_path('/upload/offer/'),  $filenametostore);

            $filePath_traite = '/upload/offer/' . $filenametostore;
    ...
    static function cv_file(UploadedFile $request)
    {
        $result = [];
        ...
        if ($request != NULL) {
            ...
            //filename to store
            $filenametostore = $filename . '_' . time() . '_cv.' . $extension;

            //Upload File
            $request->move(public_path('/upload/cv/'),  $filenametostore);

            $filePath_traite = '/upload/cv/' . $filenametostore;
